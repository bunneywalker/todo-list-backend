...
SECRET_KEY = 'django-insecure-c5ncip%j1(^%)#e_*v1+j*cn&bri3b&_z(n)&ie)+(5q6$=k0v'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://todo-list-frontend-mriy.onrender.com",  # Allow the React frontend to access the API
]
